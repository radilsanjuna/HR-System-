...
public class Add_HR_Assistant extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("HR Assistant Name");
    ...
    String assistantName = jTextField1.getText();
    String username = jTextField3.getText();
    String password = jTextField2.getText();

    if (assistantName.isEmpty() || username.isEmpty() || password.isEmpty()) {
    ...
    try (Connection conn = DatabaseConnection.getConnection()) {
        ...
        PreparedStatement checkStmt = conn.prepareStatement("SELECT COUNT(*) FROM hr_assistant WHERE username = ?");
        ...
        // 2. Insert new HR Assistant
        PreparedStatement insertStmt = conn.prepareStatement(
            "INSERT INTO hr_assistant (hr_assistant_name, username, password) VALUES (?, ?, ?)"
        );
        insertStmt.setString(1, assistantName);
        insertStmt.setString(2, username);
        insertStmt.setString(3, password);

        int rowsInserted = insertStmt.executeUpdate();
        if (rowsInserted > 0) {
            JOptionPane.showMessageDialog(this, "HR Assistant added successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
            jTextField1.setText("");
            jTextField2.setText("");
            jTextField3.setText("");
        }
        ...
        JOptionPane.showMessageDialog(this, "Error saving HR Assistant: " + e.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
    }
